...
def _EnzoSynch(field,data):
    P = 3.2 # P is the power law exponent                                                                                  
    ...
    omegac = BulletConstants.OmegaCPreFactor * data['BMag']
    omega =  2.0 * pi * BulletConstants.RadioFrequency * (1 + BulletConstants.redshift)
    return  Eta * BulletConstants.RadioPreFactor * PFactor * pow(data['BMag'],3.0) * pow(omega/omegac,-(P-1.0)/2.0)
...
def SetAlign(dataB1, phi, theta, psi, ConstrainPhi = False):
    ...
    # This is currently set to 5 arcseconds
    ...
    align.dmax[2]= BulletConstants.DataShift * BulletConstants.AngularScale * 2.0
    align.dmin[2]=-align.dmax[2]
    align.dmax[3]= BulletConstants.DataShift * BulletConstants.AngularScale * 2.0
