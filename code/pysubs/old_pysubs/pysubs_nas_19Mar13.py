...
def FindFom(snapmin,snapmax,Z,phi,theta,psi,RelVel,ConstrainPhi=True,TFudge = 1.0,Mask=(1,0,0,0,0,0,0)):
	...
	[dyyD,dxxD] = meshgrid(dataD.y,dataD.x)# Data grid for plots
        ...
        MinVz = BulletConstants.BulletVz - 9.0 * BulletConstants.BulletSigVz # Minimum Bullet radial velocity consistent with observations
        MaxVz = BulletConstants.BulletVz + 9.0 * BulletConstants.BulletSigVz # Maximum Bullet radial velocity consistent with observations
