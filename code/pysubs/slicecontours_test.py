...
pp=PdfPages('Graph_MassContours_Test.pdf')
gaslevels = [0.001,0.00178,0.00316,0.00562,0.01,0.0178,0.0316,0.0562,0.1,0.178,0.316,0.562,1.0,1.78,3.16,5.62,10.0,17.8,31.6,56.2,100.0]#[10**-4.0,10**-3.5,10**-3.0,10**-2.5,-2.0]
...
for snap in range(snapmin,snapmax):
    ...
    print "Phi = %.4f, Theta=%.4f, Psi = %.4f"%(phi,theta,psi)
