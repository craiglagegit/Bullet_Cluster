...
def FindFom(snapmin,snapmax,Z,phi,theta,psi,ConstrainPhi=True, Mask=(1,0,0,0,0,0,0)):
	...
	DeltaPsi = 10 # Using Psi and Theta 100* psi and theta, so I can use integers
	DeltaTheta = 10 # Using DeltaPsi and Delta theta of 0.10 radians or about 6 degrees
