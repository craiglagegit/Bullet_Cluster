...
double	alpha;		// X-axis scale
double	beta;		// Y-axis scale should always equal 1.0
double	gamma;		// Z-axis scale
double	P;		// Ratio of Z to X axes - P<1, Q=1 => oblate
double	Q;		// Ratio of Y to X axes - P=1, Q<1 +> prolate
double MaxProb;		// Maximum Probability for calculating Random Direction
...
struct UMass
// This data structure holds look-up arrays for the gas mass and U. 
{
double*	rx;
double* ux;
double*	r;
