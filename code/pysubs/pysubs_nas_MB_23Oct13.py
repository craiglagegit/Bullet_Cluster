...
def FindFom(snapmin,snapmax,Z,phi,theta,psi,ConstrainPhi=True,TFudge = 1.0,Mask=(1,0,0,0,0,0,0),MaxShift=0.0,SpectralIndex=3.2):
	...
	# This version first scans through a Theta,Psi matrix to determine the optimum.
        ...
        MinVz = 0.0#BulletConstants.BulletVz - 3.0 * BulletConstants.BulletSigVz # Minimum Bullet radial velocity consistent with observations
        MaxVz = 10000.0#BulletConstants.BulletVz + 3.0 * BulletConstants.BulletSigVz # Maximum Bullet radial velocity consistent with observations
