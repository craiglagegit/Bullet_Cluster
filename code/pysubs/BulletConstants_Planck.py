...
AreaFactor = 1E-4 / (4*np.pi*(1.5888E6*3.09E19)**2) # Detector area/(4*pi*R^2) - Ratioing to 1cm2 area unit
...
AngularScale = 4.58598 # Angular scale at Bullet Cluster in kps/"
