...
void reorder_particles(void)
{
  ...
  float mass_source, quantity_source1, quantity_source2, quantity_source3, quantity_source4, hsml_source, mass_save, quantity_save1, quantity_save2, quantity_save3, quantity_save4, hsml_save;   
  ...
  for(i = 0; i < NumPart; i++)
      ...
      if(Id[i] != i)
	{
	  ...
	  idsource = Id[i];
          mass_source = Mass[i];
          quantity_source1 = Quantity1[i];
          quantity_source2 = Quantity2[i];
          quantity_source3 = Quantity3[i];
          quantity_source4 = Quantity4[i];
          hsml_source = Hsml[i];
	  ...
	  do
	    {
	      ...
	      idsave = Id[dest];
              mass_save = Mass[dest];
              quantity_save1 = Quantity1[dest];
              quantity_save2 = Quantity2[dest];
              quantity_save3 = Quantity3[dest];
              quantity_save4 = Quantity4[dest];
              hsml_save = Hsml[dest];
	      ...
	      Id[dest] = idsource;
              ...
              Quantity1[dest] = quantity_source1; 
              Quantity2[dest] = quantity_source2; 
              Quantity3[dest] = quantity_source3; 
              Quantity4[dest] = quantity_source4; 
		...
		break;
	      ...
	      idsource = idsave;
              ...
              quantity_source1 = quantity_save1;
              quantity_source2 = quantity_save2;
              quantity_source3 = quantity_save3;
              quantity_source4 = quantity_save4;
