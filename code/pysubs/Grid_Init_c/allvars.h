...
extern float *Hsml;
extern float *Quantity1, *Quantity2, *Quantity3, *Quantity4;
extern float *Mass;
extern float *Rho;
...
extern int Xpixels, Ypixels, Zpixels;

extern float *Value, *ValueQuantity1, *ValueQuantity2, *ValueQuantity3, *ValueQuantity4;
