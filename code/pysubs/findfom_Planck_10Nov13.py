...
import BulletConstants_Planck as BulletConstants # Constants used in Bullet cluster simulations
import matplotlib
matplotlib.use("PDF")
import pysubs_nas_Planck_10Nov13 as pysubs
from pylab import *
import time
...
fomfile=open('newfom_massx1_planck.out','w')
