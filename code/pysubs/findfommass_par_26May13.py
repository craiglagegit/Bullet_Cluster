...
import matplotlib
matplotlib.use("PDF")
import pysubs_nas_par_26May13 as pysubs
from pylab import *
import time
...
Mask=(1,0,0,0,0,0)
(bestmassfom,bestmassx1fom,bestmasssnap,bestmassphi,bestmasstheta,bestmasspsi,bestmasstime,counter) = pysubs.FindFom(snapmin,snapmax,Z,phi,theta,psi,RelVel,ConstrainPhi=ConstrainPhi, TFudge=TFudge,Mask=Mask, MaxShift=MaxShift, SpectralIndex=SpectralIndex)
result="FOM=%.6f, XFOM=%.6f, BestSnap = %d, BestTime =  %.4f, BestPhi = %.3f, BestTheta = %.3f, BestPsi = %.3f\n"%(bestmassfom,bestmassx1fom,bestmasssnap,bestmasstime,bestmassphi,bestmasstheta,bestmasspsi)
PlotSuffix = 'Mass_Full'
pysubs.BestPlot(bestmasssnap,Z,phi,bestmasstheta,bestmasspsi,PlotSuffix=PlotSuffix,TFudge=TFudge,FomLocate=True,ConstrainPhi=ConstrainPhi,Mask=Mask, MaxShift=MaxShift, SpectralIndex=SpectralIndex)
