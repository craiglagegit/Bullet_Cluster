...
import matplotlib
matplotlib.use("PDF")
import pysubs_nas_5May13 as pysubs
from pylab import *
import time
...
Mask=(1,0,0,0,0,0)
(bestmassx1fom,bestmassx1snap,bestmassx1phi,bestmassx1theta,bestmassx1psi,bestmassx1time,counter) = pysubs.FindFom(snapmin,snapmax,Z,phi,theta,psi,RelVel,ConstrainPhi=ConstrainPhi, TFudge=TFudge,Mask=Mask, MaxShift=MaxShift, SpectralIndex=SpectralIndex)
