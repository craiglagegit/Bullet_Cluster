...
import matplotlib
matplotlib.use("PDF")
import pysubs_nas_11Feb13_oldsigma as pysubs
from pylab import *
import time
...
Mask=(1,0,0,0,0,0)
(bestmassfom,bestmasssnap,bestmassphi,bestmasstheta,bestmasspsi,bestmasstime,counter) = pysubs.FindFom(snapmin,snapmax,Z,phi,theta,psi,RelVel,ConstrainPhi=ConstrainPhi,TFudge=TFudge,Mask=Mask)
...
PlotSuffix = 'Mass_OldSigma'
pysubs.BestPlot(bestmasssnap,Z,phi,bestmasstheta,bestmasspsi,PlotSuffix=PlotSuffix,TFudge=TFudge,FomLocate=True,ConstrainPhi=ConstrainPhi,Mask=Mask)
fomfile=open('newfom_mass_oldsigma.out','w')
fomfile.write(result)
fomfile.close

Mask=(1,1,0,0,0,0)
(bestmassx1fom,bestmassx1snap,bestmassx1phi,bestmassx1theta,bestmassx1psi,bestmassx1time,counter) = pysubs.FindFom(snapmin,snapmax,Z,phi,theta,psi,RelVel,ConstrainPhi=ConstrainPhi, TFudge=TFudge,Mask=Mask)
result="FOM=%.6f, BestSnap = %d, BestTime =  %.4f, BestPhi = %.3f, BestTheta = %.3f, BestPsi = %.3f\n"%(bestmassx1fom,bestmassx1snap,bestmassx1time,bestmassx1phi,bestmassx1theta,bestmassx1psi)
PlotSuffix = 'MassX1_OldSigma'
pysubs.BestPlot(bestmassx1snap,Z,phi,bestmassx1theta,bestmassx1psi,PlotSuffix=PlotSuffix,TFudge=TFudge,FomLocate=True,ConstrainPhi=ConstrainPhi,Mask=Mask)
fomfile=open('newfom_massx1_oldsigma.out','w')
fomfile.write(result)
fomfile.close
...
(bestmassx1fom,bestmassx1snap,bestmassx1phi,bestmassx1theta,bestmassx1psi,bestmassx1time,counter) = pysubs.FindFom(snapmin,snapmax,Z,phi,theta,psi,RelVel,ConstrainPhi=ConstrainPhi, TFudge=TFudge,Mask=Mask)
result="FOM=%.6f, BestSnap = %d, BestTime =  %.4f, BestPhi = %.3f, BestTheta = %.3f, BestPsi = %.3f\n"%(bestmassx1fom,bestmassx1snap,bestmassx1time,bestmassx1phi,bestmassx1theta,bestmassx1psi)
PlotSuffix = 'X1_OldSigma'
pysubs.BestPlot(bestmassx1snap,Z,phi,bestmassx1theta,bestmassx1psi,PlotSuffix=PlotSuffix,TFudge=TFudge,FomLocate=True,ConstrainPhi=ConstrainPhi,Mask=Mask)
fomfile=open('newfom_x1_oldsigma.out','w')
fomfile.write(result)
fomfile.close
