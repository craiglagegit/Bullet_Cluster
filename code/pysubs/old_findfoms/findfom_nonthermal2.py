...
import matplotlib
matplotlib.use("PDF")
import pysubs_nas_23Jan13_nonthermal2 as pysubs
from pylab import *
import time
...
fomfile=open('newfom_mass_nonthermal2.out','w')
...
fomfile=open('newfom_massx1_nonthermal2.out','w')
fomfile.write(result)
fomfile.close
