...
import pysubs_mhd_apec_25Apr12 as pysubs
import time
...
start = time.time()
(fom,snap,phi,theta,simtime,counter) = pysubs.FindFom2(snapmin,snapmax,Z,phi,theta,psi,NumAngles=8,ConstrainPsi=ConstrainPsi)
...
fomfile=open('newfom_apec_new_kappa.out','w')
