...
import matplotlib
matplotlib.use("PDF")
import pysubs_nas_12Feb13_spectrum as pysubs
from pylab import *
import time
...
fomfile=open('newfom_mass_test.out','w')
fomfile.write(result)
fomfile.close
"""
Mask=(1,1,0,0,0,0)
pysubs.FindSpectrum(snapmin,snapmax,Z,TFudge=TFudge)
...
PlotSuffix = 'MassX1_Test_NewApec'
...
fomfile=open('newfom_massx1_test_newapec.out','w')
fomfile.write(result)
fomfile.close
