...
Readtime=Gridtime=Magtime=Etime=Wtime=DMtime=0.0
...
GadgetSnapshotFile  = 'snapshot_000'
GadgetParameterFile  = 'collision.param'
EnzoParameterFile   = 'AMRTest.enzo'

snapfile = pysubs.ReadGadgetSnapshot(GadgetSnapshotFile)
...
Readtime = Readtime + time.time() - lasttime
lasttime = time.time()
...
for i in range(NumGrids): 
	...
	Gridtime = Gridtime + time.time() - lasttime
	lasttime = time.time()
	...
	Magtime = Magtime + time.time() - lasttime
	lasttime = time.time()
	...
	Etime = Etime + time.time() - lasttime
	lasttime = time.time()
	...
	Wtime = Wtime + time.time() - lasttime
	lasttime = time.time()
...
DMtime = DMtime + time.time() - lasttime
lasttime = time.time()

print "Total DM Mass for %d particles is %e MSun\n"%(totpart,totsum)

print "Readtime = %f, Gridtime = %f, Magtime = %f, ETime = %f, Wtime = %f, DMtime = %f\n"%(Readtime,Gridtime,Magtime,Etime,Wtime,DMtime)
#************END MAIN PROGRAM*************************
