...
double GetDoubleParam(string fname, string parnam, double defval)
{
...
int GetIntParam(string fname, string parnam, int defval)
{
  string parval = ReadPar(fname, parnam);
  if (parval.compare("") == 0)
    {
...
double* GetDoubleList(string fname, string parnam, int numvals, double* defval)
{
  string parval = ReadPar(fname, parnam);
  size_t found;
  string first;
...
int* GetIntList(string fname, string parnam, int numvals, int* defval)
{
  string parval = ReadPar(fname, parnam);
  size_t found;
  string first;
...
string  GetStringParam(string fname, string parnam, string defval)
{
  string parval = ReadPar(fname, parnam);
  if (parval.compare("") == 0)
    {
