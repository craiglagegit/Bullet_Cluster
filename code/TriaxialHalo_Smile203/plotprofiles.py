...
filenamebase = 'test2/snapshots/fulltest2'
...
figure()
for snap in  [0,6,13]:#[0,10,20,30,40,50]:
	if snap<10:
	...
	xmin = -2000.0 + Centroids[1,1,0]
	xmax = 2000.0 + Centroids[1,1,0]
	ymin = -2000.0 + Centroids[1,1,1]
	ymax = 2000.0 + Centroids[1,1,1]
	zmin = -2000.0 + Centroids[1,1,2]
...
legend(loc=1,bbox_to_anchor=[1.25, 0.95])
show()
